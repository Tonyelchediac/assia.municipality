  ...
  footer.innerHTML = ` 
          <div class="container">
              ...
              <div class="footer-bottom">
                  ...
                  <p>تصميم وتطوير قسم التكنولوجيا والمعلومات ECSS</p>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const privacyContent = `
        ...
        <h3>الاتصال بنا</h3>
        <p>إذا كان لديكم أي أسئلة أو استفسارات حول سياسة الخصوصية هذه، يرجى التواصل معنا عبر البريد الإلكتروني: <a href="mailto:info.ecss.lb@gmail.com">info.ecss.lb@gmail.com</a></p>
  `;
 ...
 const termsContent = `
  ...
  <h3>اتصل بنا</h3>
  <p>لأي استفسار، يرجى التواصل عبر: <a href="mailto:info.ecss.lb@gmail.com">info.ecss.lb@gmail.com</a></p>
`;
